...
void plot_varygDM()
{
  ...
  TH2F* hxSec = new TH2F("hxSec","2HDM+a cross sections @ #sqrt{s}=13.6 TeV [pb]",7,0.5,7.5,3,0.5,3.5);
  ...
  c1->Print("2HDMa_varygDM_explictbb.pdf");
  c1->Print("2HDMa_varygDM_explictbb.gif");
}
