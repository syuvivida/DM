...
# with command line options: STEP2 --step RAW2DIGI,L1Reco,RECO --conditions auto:mc --pileup 2012_Summer_50ns_PoissonOOTPU --datamix NODATAMIXER --eventcontent AODSIM,DQM --datatier AODSIM,DQM
...
process.DQMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('STEP2_RAW2DIGI_L1Reco_RECO_PU_inDQM.root'),
    dataset = cms.untracked.PSet(
        filterName = cms.untracked.string(''),
