...
# with command line options: step1 --filein file:B2G-RunIISpring16reHLT80-00107.root --fileout file:B2G-RunIISpring16MiniAODv2-01089.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 80X_mcRun2_asymptotic_v14 --customise_commands process.patTrigger.processName = cms.string('HLT2') --step PAT --era Run2_2016 --python_filename /afs/cern.ch/cms/PPD/PdmV/work/McM/submit/B2G-RunIISpring16MiniAODv2-01089/B2G-RunIISpring16MiniAODv2-01089_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 1920
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:monoHiggs_step4.root'),
