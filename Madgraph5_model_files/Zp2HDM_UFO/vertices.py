...
V_5 = Vertex(name = 'V_5',
             particles = [ P.n1__tilde__, P.n1, P.h ],
             color = [ '1' ],
             lorentz = [ L.FFS2 ],
...
V_89 = Vertex(name = 'V_89',
              particles = [ P.Z, P.Zp, P.chi, P.chi ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
...
V_100 = Vertex(name = 'V_100',
               particles = [ P.Zp, P.Zp, P.chi, P.chi ],
               color = [ '1' ],
               lorentz = [ L.VVSS1 ],
...
V_125 = Vertex(name = 'V_125',
               ...
               color = [ '1' ],
               lorentz = [ L.FFV2, L.FFV5 ],
               couplings = {(0,1):C.GC_63,(0,0):C.GC_54})
...
V_127 = Vertex(name = 'V_127',
               ...
               color = [ '1' ],
               lorentz = [ L.FFV2, L.FFV5 ],
               couplings = {(0,0):C.GC_59,(0,1):C.GC_65})
...
V_139 = Vertex(name = 'V_139',
               ...
               couplings = {(0,0):C.GC_55,(0,2):C.GC_62,(0,1):C.GC_20})
...
V_142 = Vertex(name = 'V_142',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV2, L.FFV3, L.FFV6 ],
               couplings = {(0,0):C.GC_58,(0,2):C.GC_64,(0,1):C.GC_18})
...
V_154 = Vertex(name = 'V_154',
               ...
               couplings = {(0,0):C.GC_54,(0,1):C.GC_62})
...
V_157 = Vertex(name = 'V_157',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV2, L.FFV4 ],
               couplings = {(0,0):C.GC_59,(0,1):C.GC_64})
