...
V_8 = Vertex(name = 'V_8',
             particles = [ P.b__tilde__, P.b, P.H__neutral__ ],
             color = [ 'Identity(1,2)' ],
             lorentz = [ L.FFS5 ],
...
V_12 = Vertex(name = 'V_12',
              particles = [ P.ta__plus__, P.ta__minus__, P.H__neutral__ ],
              color = [ '1' ],
              lorentz = [ L.FFS5 ],
...
V_17 = Vertex(name = 'V_17',
              particles = [ P.t__tilde__, P.t, P.H__neutral__ ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS5 ],
...
V_21 = Vertex(name = 'V_21',
              particles = [ P.a, P.W__minus__, P.H__neutral__, P.H__plus__ ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
...
V_25 = Vertex(name = 'V_25',
              particles = [ P.W__minus__, P.H__neutral__, P.H__plus__ ],
              color = [ '1' ],
              lorentz = [ L.VSS1 ],
...
V_29 = Vertex(name = 'V_29',
              particles = [ P.a, P.W__plus__, P.H__neutral__, P.H__minus__ ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
...
V_33 = Vertex(name = 'V_33',
              particles = [ P.W__plus__, P.H__neutral__, P.H__minus__ ],
              color = [ '1' ],
              lorentz = [ L.VSS1 ],
              couplings = {(0,0):C.GC_34})
...
V_36 = Vertex(name = 'V_36',
              particles = [ P.W__minus__, P.W__plus__, P.H__neutral__, P.H__neutral__ ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
              couplings = {(0,0):C.GC_22})
...
V_38 = Vertex(name = 'V_38',
              particles = [ P.W__minus__, P.W__plus__, P.H__neutral__ ],
              color = [ '1' ],
              lorentz = [ L.VVS1 ],
...
V_47 = Vertex(name = 'V_47',
              particles = [ P.Z, P.A0, P.H__neutral__ ],
              color = [ '1' ],
              lorentz = [ L.VSS1 ],
...
V_52 = Vertex(name = 'V_52',
              particles = [ P.W__minus__, P.Z, P.H__neutral__, P.H__plus__ ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
...
V_56 = Vertex(name = 'V_56',
              particles = [ P.W__plus__, P.Z, P.H__neutral__, P.H__minus__ ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
...
V_61 = Vertex(name = 'V_61',
              particles = [ P.Z, P.Z, P.H__neutral__, P.H__neutral__ ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
...
V_63 = Vertex(name = 'V_63',
              particles = [ P.Z, P.Z, P.h, P.H__neutral__ ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
              couplings = {(0,0):C.GC_65})

V_64 = Vertex(name = 'V_64',
              particles = [ P.Z, P.Z, P.H__neutral__ ],
              color = [ '1' ],
              lorentz = [ L.VVS1 ],
...
V_69 = Vertex(name = 'V_69',
              particles = [ P.Zp, P.A0, P.H__neutral__ ],
              color = [ '1' ],
              lorentz = [ L.VSS1 ],
...
V_74 = Vertex(name = 'V_74',
              particles = [ P.W__minus__, P.Zp, P.H__neutral__, P.H__plus__ ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
...
V_78 = Vertex(name = 'V_78',
              particles = [ P.W__plus__, P.Zp, P.H__neutral__, P.H__minus__ ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
...
V_84 = Vertex(name = 'V_84',
              particles = [ P.Z, P.Zp, P.H__neutral__, P.H__neutral__ ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
...
V_87 = Vertex(name = 'V_87',
              particles = [ P.Z, P.Zp, P.h, P.H__neutral__ ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
              couplings = {(0,0):C.GC_64})

V_88 = Vertex(name = 'V_88',
              particles = [ P.Z, P.Zp, P.H__neutral__ ],
              color = [ '1' ],
              lorentz = [ L.VVS1 ],
...
V_97 = Vertex(name = 'V_97',
              particles = [ P.Zp, P.Zp, P.h, P.H__neutral__ ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
              couplings = {(0,0):C.GC_66})

V_98 = Vertex(name = 'V_98',
              particles = [ P.Zp, P.Zp, P.H__neutral__, P.H__neutral__ ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
...
V_101 = Vertex(name = 'V_101',
               particles = [ P.Zp, P.Zp, P.H__neutral__ ],
               color = [ '1' ],
               lorentz = [ L.VVS1 ],
