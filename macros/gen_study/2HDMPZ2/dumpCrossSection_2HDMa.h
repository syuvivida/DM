...
// Tue Jul 31 17:14:40 2018 by ROOT version 6.08/07
// from TTree LHEF/Analysis tree
// found on file: 306000_MH3_1500_MH4_150_MH2_1500_MHC_1500_slc6_amd64_gcc481_CMSSW_7_1_30.root
//////////////////////////////////////////////////////////

#ifndef dumpCrossSection_2HDMa_h
#define dumpCrossSection_2HDMa_h
...
const Int_t kMaxRwgt = 939;
const Int_t kMaxParticle = 6;


class dumpCrossSection_2HDMa {
public :
   ...
   dumpCrossSection_2HDMa(string inputFile, TTree *tree=0);
   virtual ~dumpCrossSection_2HDMa();
...
#ifdef dumpCrossSection_2HDMa_cxx
dumpCrossSection_2HDMa::dumpCrossSection_2HDMa(string inputFile, TTree *tree) : fChain(0) 
{
...
dumpCrossSection_2HDMa::~dumpCrossSection_2HDMa()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t dumpCrossSection_2HDMa::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t dumpCrossSection_2HDMa::LoadTree(Long64_t entry)
{
...
void dumpCrossSection_2HDMa::Init(TTree *tree)
{
...
Bool_t dumpCrossSection_2HDMa::Notify()
{
...
void dumpCrossSection_2HDMa::Show(Long64_t entry)
{
...
Int_t dumpCrossSection_2HDMa::Cut(Long64_t entry)
{
...
#endif // #ifdef dumpCrossSection_2HDMa_cxx
