...
int simpleDMDrawer(string input, bool debug=false){
  ...
  th1[5]=new TH1D("m3b_LHE","m3b_LHE",nbins*2,xmin,xmax*2);

  th2[0]=new TH2D("METvsmchichi","METvsmchichi",nbins,xmin,xmax,nbins,xmin,xmax);
  th2[1]=new TH2D("METvm3b","METvsm3b",nbins,xmin,xmax,2*nbins,xmin,2*xmax);
  th2[2]=new TH2D("mchichivsm3b","mchichivsm3b",nbins,xmin,xmax,2*nbins,xmin,2*xmax);
