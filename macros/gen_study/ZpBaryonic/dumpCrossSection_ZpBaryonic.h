...
// Tue Jul 31 16:13:07 2018 by ROOT version 6.08/07
// from TTree LHEF/Analysis tree
// found on file: 263400_ZpBaryonic_MZp1000_MChi1_slc6_amd64_gcc481_CMSSW_7_1_30.root
//////////////////////////////////////////////////////////

#ifndef dumpCrossSection_ZpBaryonic_h
#define dumpCrossSection_ZpBaryonic_h
...
const Int_t kMaxRwgt = 670;
const Int_t kMaxParticle = 6;

class dumpCrossSection_ZpBaryonic {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   dumpCrossSection_ZpBaryonic(string inputFile, TTree *tree=0);
   virtual ~dumpCrossSection_ZpBaryonic();
...
#ifdef dumpCrossSection_ZpBaryonic_cxx
dumpCrossSection_ZpBaryonic::dumpCrossSection_ZpBaryonic(string inputFile, TTree *tree) : fChain(0) 
{
...
dumpCrossSection_ZpBaryonic::~dumpCrossSection_ZpBaryonic()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t dumpCrossSection_ZpBaryonic::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t dumpCrossSection_ZpBaryonic::LoadTree(Long64_t entry)
{
...
void dumpCrossSection_ZpBaryonic::Init(TTree *tree)
{
...
Bool_t dumpCrossSection_ZpBaryonic::Notify()
{
...
void dumpCrossSection_ZpBaryonic::Show(Long64_t entry)
{
...
Int_t dumpCrossSection_ZpBaryonic::Cut(Long64_t entry)
{
...
#endif // #ifdef dumpCrossSection_ZpBaryonic_cxx
