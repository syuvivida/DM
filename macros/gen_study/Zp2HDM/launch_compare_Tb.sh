...
gzARRAY=(0.4 0.6 0.8 1.0 1.5 2.0 2.5 3.0)
...
do
  ...
  gz=${gzARRAY[$i]}
  gzname=${gz/\./p} 
  filename=/data7/monoH/monoH_genOnly/Zp2HDM/varyTb/Tb$gzname/output/gentuple_2HDM_MZp${mmed}_MA0${ma0}_MDM${mdm}.root
  legend="tan#beta="$gz
