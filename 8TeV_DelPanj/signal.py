...
process.source = cms.Source("PoolSource",
        ...
        'file:step3_zp_hA0_bbxx_run_2.root',
        'file:step3_zp_hA0_bbxx_run_3.root',
        'file:step3_zp_hA0_bbxx_run_4.root',
        'file:step3_zp_hA0_bbxx_run_5.root',
        'file:step3_zp_hA0_bbxx_run_6.root',
        'file:step3_zp_hA0_bbxx_run_7.root',
        'file:step3_zp_hA0_bbxx_run_8.root',
        'file:step3_zp_hA0_bbxx_run_9.root',
        'file:step3_zp_hA0_bbxx_run_10.root'
        )
                            )
