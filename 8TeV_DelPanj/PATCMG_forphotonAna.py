...
process.source = cms.Source("PoolSource",
       ...
       # 'file:/afs/cern.ch/work/s/syu/public/monoHiggs/step3_zp_hA0_bbxx_run_1.root'
        'file:/afs/cern.ch/work/y/yunju/private/Samples2015/DM_SiM_SSD_jj_8TeV_steps_300/step3_DM_SiM_SSD_jj_8TeV.root'
...
process.tree = cms.EDAnalyzer(
    ...
    photonLabelPY=cms.InputTag("photons"), 
...
process.eiko_e = cms.Path(process.ZToEEcand * process.ZToEEfilter* process.kt6PFJets25* process.tree)
process.eiko_m = cms.Path(process.ZToMUMUcand * process.ZToMUMUfilter*process.kt6PFJets25*process.tree)
process.eiko = cms.Path(process.kt6PFJets25*process.tree)
