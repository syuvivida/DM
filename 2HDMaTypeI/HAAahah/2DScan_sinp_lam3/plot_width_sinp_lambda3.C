...
void plot_width_sinp_lambda3()
{
  ...
  TH2F* hxSec = new TH2F("hxSec","Type-I 2HDM+a: H#rightarrow AA#rightarrow haha#rightarrow hh+4#chi @ #sqrt{s}=13.6 TeV, #Gamma_{H}/M_{H}",nA,0.5,nA+.5,nH,0.5,nH+.5);
  ...
  pt->SetTextSize(0.05); 
  c1->Modified(); 
  c1->Print("2HDMaI_width_explictHAAahah_tanbeta2_mH500_mA230.pdf");
  c1->Print("2HDMaI_width_explictHAAahah_tanbeta2_mH500_mA230.gif");
}
