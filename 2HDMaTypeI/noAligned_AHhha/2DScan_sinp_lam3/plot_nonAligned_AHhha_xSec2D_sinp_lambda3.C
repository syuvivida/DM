...
void plot_nonAligned_AHhha_xSec2D_sinp_lambda3()
{
  ...
  TH2F* hxSec = new TH2F("hxSec","Type-I 2HDM+a: A#rightarrow Ha#rightarrow hh+2#chi @ #sqrt{s}=13.6 TeV [pb]",nA,0.5,nA+.5,nH,0.5,nH+.5);
  ...
  pt->SetTextSize(0.05); 
  c1->Modified(); 
  c1->Print("2HDMaI_noAligned_tanbeta2_mA410_mH260.pdf");
  c1->Print("2HDMaI_noAligned_tanbeta2_mA410_mH260.gif");
}
