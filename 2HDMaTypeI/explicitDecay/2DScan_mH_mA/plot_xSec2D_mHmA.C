...
void plot_xSec2D_mHmA()
{
  ...
  TH2F* hxSec = new TH2F("hxSec","Type-I 2HDM+a H#rightarrow AA#rightarrow haha#rightarrow hh+4#chi @ #sqrt{s}=13.6 TeV [pb]",nA,0.5,nA+.5,nH,0.5,nH+.5);
  ...
  TLatex *lar = new TLatex(0.452722, 0.221053, "tan#beta=2, #lambda_{3}=2, sin#theta=0.1");
  lar->SetNDC(kTRUE);
  ...
  pt->SetTextSize(0.05); 
  c1->Modified(); 
  c1->Print("2HDMaI_explictHAAahah_tanbeta2_lambda3_2_sint0p1.pdf");
  c1->Print("2HDMaI_explictHAAahah_tanbeta2_lambda3_2_sint0p1.gif");
}
